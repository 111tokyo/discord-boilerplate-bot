  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <Link href="https://discord.com/oauth2/authorize?client_id=1256906109151875092&response_type=code&redirect_uri=https%3A%2F%2Flimbot.vercel.app%2Fdashboard%2Fonce&scope=identify+guilds">
          <Button>
